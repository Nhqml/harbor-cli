...
/// struct for typed errors of method [`get_statistic`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetStatisticError {
...
pub async fn get_statistic(
...
) -> Result<crate::models::Statistic, Error<GetStatisticError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetStatisticError> =
