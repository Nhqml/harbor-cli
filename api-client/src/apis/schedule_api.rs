...
/// struct for typed errors of method [`get_schedule_paused`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSchedulePausedError {
...
pub async fn get_schedule_paused(
    configuration: &configuration::Configuration,
    job_type: &str,
    x_request_id: Option<&str>,
) -> Result<crate::models::SchedulerStatus, Error<GetSchedulePausedError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSchedulePausedError> =
...
) -> Result<Vec<crate::models::ScheduleTask>, Error<ListSchedulesError>> {
    let local_var_configuration = configuration;
