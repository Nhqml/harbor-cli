...
pub struct RetentionRule {
    ...
    pub tag_selectors: Option<Vec<crate::models::RetentionSelector>>,
    #[serde(rename = "scope_selectors", skip_serializing_if = "Option::is_none")]
    pub scope_selectors:
        Option<::std::collections::HashMap<String, Vec<crate::models::RetentionSelector>>>,
}

impl RetentionRule {
    pub fn new() -> RetentionRule {
        RetentionRule {
            id: None,
            priority: None,
            disabled: None,
